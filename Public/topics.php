...
?>
        ...
        <div id="eachBox">
          <a href="subject.php?tag=techEngineering"><div id="topic">TECH & ENGINEERING</div></a>
          <a href="subject.php?tag=environmentNature"><div id="topic">ENVIRONMENT & NATURE</div></a>
          <a href="subject.php?tag=healthBeauty"><div id="topic">HEALTH & BEAUTY</div></a>
          <a href="subject.php?tag=musicEntertainment"><div id="topic">MUSIC & ENTERTAINMENT</div></a>
          <a href="subject.php?tag=social"><div id="topic">SOCIAL</div></a>
        </div>
          
        <div id="eachBox">
          <a href="subject.php?tag=world"><div id="topic">WORLD</div></a>
